...
import { SettingsOptionsData, ContentData } from "../../types";
...
export const Settings = ({
  ...
  const settingsOptionsData: SettingsOptionsData = [
    {
      title: "User Information",
      iconName: "info-circle",
      content: "kwdokwdkwddw",
    },
    {
      title: "Regulations",
      iconName: "pen-nib",
      content: [
        {
          ...
          subSections: {
            ...
            third:
              "The administrator of the Application is PhotoNest, with its registered office at [Company Address].",
          },
        },
        {
          id: 2,
        ...
        },
        {
          ...
          subSections: {
            ...
            third:
              "Any comments or concerns regarding the operation of the Application should be addressed to [contact@email.com].",
          },
        },
      ],
    },
      ...
      content: [
        {
          ...
          subSections: {
            first:
              "The Application collects the following personal data of Users: Email address (for registration and communication with the User), User profile-related data such as username and profile picture, Information about User activities within the Application, such as uploading photos and giving likes.",
            second: "",
          },
        },
        {
        ...
        },
        {
          ...
          subSections: {
            first:
              "Any questions regarding the Privacy Policy should be directed to [contact@email.com].",
            second: "",
          },
        },
        {
